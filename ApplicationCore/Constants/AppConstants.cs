...
namespace ApplicationCore.Constants
{
    public static class AppConstants
    {
        ...
        public static PrintTemplateType[] PrintTemplateTypeDemo = new PrintTemplateType[] {
           ...
           new PrintTemplateType {Type = "tmp_customer_debt" , PathTemplate = "PrintTemplate/PhieuThuChi/Template_Customer_Debt.html", Model = "customer.debt" , NameIRModel = "print_template_customer_debt" },
           new PrintTemplateType {Type = "tmp_agent_commission" , PathTemplate = "PrintTemplate/PhieuThuChi/Template_Agent_Commission.html", Model = "agent.commission" , NameIRModel = "print_template_agent_commission" },
           ...
           new PrintTemplateType {Type = "tmp_salary_employee" , PathTemplate = "PrintTemplate/Salary/Template_Salary_Employee.html", Model = "salary.employee" , NameIRModel = "print_template_salary_employee" },
           new PrintTemplateType {Type = "tmp_salary_advance" , PathTemplate = "PrintTemplate/Salary/Template_Salary_Advance.html", Model = "salary.advance" , NameIRModel = "print_template_salary_advance" },
