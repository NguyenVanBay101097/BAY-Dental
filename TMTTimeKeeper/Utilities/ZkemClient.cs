    ...
    public class ZkemClient : IZKEM
    {
        ...
        public bool Connect_Net(string IPAdd, int Port)
        {
            if (objCZKEM.Connect_Net(IPAdd, Port))
            {
                ...
                {
                    //65535, generate all eve
                    // [ Register your events here ]
                    // [ Go through the _IZKEMEvents_Event class for a complete list of events
                    objCZKEM.OnConnected += ObjCZKEM_OnConnected;
                    objCZKEM.OnDisConnected += objCZKEM_OnDisConnected;
                    objCZKEM.OnFinger += new zkemkeeper._IZKEMEvents_OnFingerEventHandler(_IZKEMEvents_OnFingerEventHandler);
                    objCZKEM.OnVerify += new zkemkeeper._IZKEMEvents_OnVerifyEventHandler(_IZKEMEvents_OnVerifyEventHandler);
                    objCZKEM.OnAttTransactionEx += new zkemkeeper._IZKEMEvents_OnAttTransactionExEventHandler(_IZKEMEvents_OnAttTransactionExEventHandler);
                    objCZKEM.OnFingerFeature += new zkemkeeper._IZKEMEvents_OnFingerFeatureEventHandler(_IZKEMEvents_OnFingerFeatureEventHandler);
                    objCZKEM.OnEnrollFinger += new zkemkeeper._IZKEMEvents_OnEnrollFingerEventHandler(_IZKEMEvents_OnEnrollFingerEventHandler);
                    objCZKEM.OnEnrollFingerEx += new zkemkeeper._IZKEMEvents_OnEnrollFingerExEventHandler(_IZKEMEvents_OnEnrollFingerExEventHandler);
                    objCZKEM.OnDeleteTemplate += new zkemkeeper._IZKEMEvents_OnDeleteTemplateEventHandler(_IZKEMEvents_OnDeleteTemplateEventHandler);
                    objCZKEM.OnNewUser += new zkemkeeper._IZKEMEvents_OnNewUserEventHandler(_IZKEMEvents_OnNewUserEventHandler);
                    objCZKEM.OnHIDNum += new zkemkeeper._IZKEMEvents_OnHIDNumEventHandler(_IZKEMEvents_OnHIDNumEventHandler);
                    objCZKEM.OnAlarm += new zkemkeeper._IZKEMEvents_OnAlarmEventHandler(_IZKEMEvents_OnAlarmEventHandler);
                    objCZKEM.OnDoor += new zkemkeeper._IZKEMEvents_OnDoorEventHandler(_IZKEMEvents_OnDoorEventHandler);
                    objCZKEM.OnWriteCard += new zkemkeeper._IZKEMEvents_OnWriteCardEventHandler(_IZKEMEvents_OnWriteCardEventHandler);
                    objCZKEM.OnEmptyCard += new zkemkeeper._IZKEMEvents_OnEmptyCardEventHandler(_IZKEMEvents_OnEmptyCardEventHandler);
        ...
        /// <summary>
        /// Event On Enroll Finger RealTime
        /// </summary>
        /// <param name="EnrollNumber"></param>
        /// <param name="IsInValid"></param>
        /// <param name="AttState">Đăng xuất: 1, Đăng nhập: 0</param>
        ...
        private void _IZKEMEvents_OnEnrollFingerExEventHandler(string EnrollNumber, int FingerIndex, int ActionResult, int TemplateLength) { }

        private void _IZKEMEvents_OnDeleteTemplateEventHandler(int EnrollNumber, int FingerIndex) { }

        private void _IZKEMEvents_OnNewUserEventHandler(int EnrollNumber) { }

        private void _IZKEMEvents_OnHIDNumEventHandler(int CardNumber) { }

        private void _IZKEMEvents_OnAlarmEventHandler(int AlarmType, int EnrollNumber, int Verified) { }

        private void _IZKEMEvents_OnDoorEventHandler(int EventType) { }

        private void _IZKEMEvents_OnWriteCardEventHandler(int EnrollNumber, int ActionResult, int Length) { }

        private void _IZKEMEvents_OnEmptyCardEventHandler(int ActionResult) { }
        ...
        public void Disconnect()
        {
            ...
            objCZKEM.OnEnrollFinger -= new zkemkeeper._IZKEMEvents_OnEnrollFingerEventHandler(_IZKEMEvents_OnEnrollFingerEventHandler);
            objCZKEM.OnFinger -= new zkemkeeper._IZKEMEvents_OnFingerEventHandler(_IZKEMEvents_OnFingerEventHandler);
            objCZKEM.OnAttTransactionEx -= new _IZKEMEvents_OnAttTransactionExEventHandler(new zkemkeeper._IZKEMEvents_OnAttTransactionExEventHandler(_IZKEMEvents_OnAttTransactionExEventHandler));
