...
@Component({
  selector: 'app-date-range-filter-dropdown',
  templateUrl: './date-range-filter-dropdown.component.html',
  styleUrls: ['./date-range-filter-dropdown.component.css'],
  host: {
    class: "o_advance_search_dropdown"
  }
})
export class DateRangeFilterDropdownComponent implements OnInit {
  formGroup: FormGroup;
  @Input() dateFrom: Date;
  @Input() title: string;
  @Input() dateTo: Date;
