...
namespace TMTDentalAdmin.Controllers
{
    ...
    public class AccountController : BaseApiController
    {
        ...
        public AccountController(UserManager<ApplicationAdminUser> userManager,
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            ...
            ApplicationAdminUser user = await _userManager.FindByNameAsync(model.Email);
            if (user == null)
            {
        ...
        private string GenerateToken(ApplicationAdminUser user, DateTime expires, IList<string> roles)
        {
