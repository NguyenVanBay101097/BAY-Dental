...
namespace TMTDentalAPI.Controllers
{
    ...
    public class DashboardReportsController : BaseApiController
    {
        ...
        public DashboardReportsController(IMapper mapper, IDashboardReportService dashboardService, ISaleReportService saleReportService, ICashBookService cashBookService)
        {
            _mapper = mapper;
