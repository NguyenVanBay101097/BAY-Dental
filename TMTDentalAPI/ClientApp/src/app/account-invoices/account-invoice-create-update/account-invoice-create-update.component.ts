...
@Component({
  selector: 'app-account-invoice-create-update',
  templateUrl: './account-invoice-create-update.component.html',
  styleUrls: ['./account-invoice-create-update.component.css'],
  host: {
    class: 'o_action o_view_controller'
  }
})
export class AccountInvoiceCreateUpdateComponent implements OnInit {
  orderForm: FormGroup;
  id: string;
  type = 'out_invoice';
  ...
  ngOnInit() {
    this.orderForm = this.fb.group({
      ...
      user: null,
      dateInvoiceObj: [null, Validators.required],
      dateInvoice: null,
    ...
    this.route.paramMap.pipe(
      switchMap((params: ParamMap) => {
        ...
        if (result.dateInvoice) {
          let dateInvoice = this.intlService.parseDate(result.dateInvoice);
          this.orderForm.get('dateInvoiceObj').setValue(dateInvoice);
        }
