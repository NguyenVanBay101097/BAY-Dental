...
@Component({
  selector: 'app-sale-order-fast-list-service',
  templateUrl: './sale-order-fast-list-service.component.html',
  styleUrls: ['./sale-order-fast-list-service.component.css']
})
export class SaleOrderFastListServiceComponent implements OnInit {
  @Input() searchText;
