...
@Component({
  selector: 'app-date-range-picker-dropdown',
  templateUrl: './date-range-picker-dropdown.component.html',
  styleUrls: ['./date-range-picker-dropdown.component.css'],
  providers: [
    LocaleService
  ],
  host: {
...
export class DateRangePickerDropdownComponent  implements OnInit {
