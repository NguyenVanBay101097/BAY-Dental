...
@Directive({
    ...
    exportAs: 'customNgxDaterangepickerMd',
    providers: [
        {
...
export class DaterangepickerDirective implements OnInit, OnChanges, DoCheck {
    ...
    constructor(
        ...
        this.drops = 'down';
        this.opens = 'auto';
        const componentFactory = this._componentFactoryResolver.resolveComponentFactory(DateRangePickerDropdownComponent );
        viewContainerRef.clear();
        const componentRef = viewContainerRef.createComponent(componentFactory);
        this.picker = (<DateRangePickerDropdownComponent >componentRef.instance);
