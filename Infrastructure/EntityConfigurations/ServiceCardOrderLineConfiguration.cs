...
{
    public class ServiceCardOrderLineConfiguration : IEntityTypeConfiguration<ServiceCardOrderLine>
    {
        public void Configure(EntityTypeBuilder<ServiceCardOrderLine> builder)
        {
