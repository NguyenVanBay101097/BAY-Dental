...
namespace Infrastructure.TenantData.Migrations
{
    ...
    [Migration("20210513073333_AddTenantOldSaleOrderProcessUpdateTable")]
    partial class AddTenantOldSaleOrderProcessUpdateTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationCore.Entities.EmployeeAdmin", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ApplicationCore.Entities.TenantExtendHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("TenantExtendHistories");
                });
            ...
            modelBuilder.Entity("ApplicationCore.Entities.AppTenant", b =>
                {
                    ...
                    b.HasOne("ApplicationCore.Entities.EmployeeAdmin", "EmployeeAdmin")
                        .WithMany()
            ...
            modelBuilder.Entity("ApplicationCore.Entities.TenantExtendHistory", b =>
                {
                    ...
                    b.HasOne("ApplicationCore.Entities.AppTenant", "AppTenant")
                        .WithMany()
