...
namespace Infrastructure.Data.Migrations
{
    ...
    [Migration("20200228034947_FacebookConfigUpdate1")]
    partial class FacebookConfigUpdate1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationCore.Entities.FacebookPageUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("ConfigPageId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ConfigPageId");

                    b.HasIndex("CreatedById");

                    b.HasIndex("WriteById");

                    b.ToTable("FacebookPageUsers");
                });
            ...
            modelBuilder.Entity("ApplicationCore.Entities.PartnerFacebookPageUserRel", b =>
                {
                    b.Property<Guid>("PartnerId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("FbPageUserId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("Psid")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("PartnerId", "FbPageUserId");

                    b.HasIndex("FbPageUserId");

                    b.ToTable("PartnerFacebookPageUserRels");
                });
            ...
            modelBuilder.Entity("ApplicationCore.Entities.FacebookPageUser", b =>
                {
                    b.HasOne("ApplicationCore.Entities.FacebookConfigPage", "ConfigPage")
                        .WithMany("PageUsers")
                        .HasForeignKey("ConfigPageId");
            ...
            modelBuilder.Entity("ApplicationCore.Entities.PartnerFacebookPageUserRel", b =>
                {
                    b.HasOne("ApplicationCore.Entities.FacebookPageUser", "FbPageUser")
                        .WithMany()
                        .HasForeignKey("FbPageUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
