...
namespace Facebook.ApiClient.Interfaces
{
    ...
    public interface IPagedResponse<TEntity> where TEntity : class, new()
    {
        ...
        IPagedResponse<TEntity> GetNextPageData(bool legacy = false);

        /// <summary>
        /// Get next page data from API
        /// </summary>
        /// <returns>Next page data</returns>
        IPagedResponse<TEntity> GetNextPageData(string requestUrl, int limit, bool legacy = false);

        /// <summary>
        /// Get next page data from API
        /// </summary>
        /// <returns>Next page data</returns>
        Task<IPagedResponse<TEntity>> GetNextPageDataAsync(bool legacy = false);
        ...
        /// </summary>
        /// <returns></returns>
        bool IsNextPageCursorAvailable();
